...
function historiaKD(){
		//A = 65; S = 83; D = 68; F = 70; G = 71; H = 72; Z = 90;
			...
			if(tecla3 == 40){
				  responsiveVoice.speak('Clique A para acessar a aula sobre Soma, clique S para acessar a aula sobre o Subtração, clique control para voltar ao menu principal', 'Brazilian Portuguese Female');
			}else if(tecla3 == 65){
